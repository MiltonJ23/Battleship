(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerPolicy&&(t.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?t.credentials="include":s.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();class $e{ctx=null;getCtx(){return this.ctx||(this.ctx=new AudioContext),this.ctx}play(n){try{const o=this.getCtx(),a=o.createOscillator(),s=o.createGain();a.connect(s),s.connect(o.destination);const t=o.currentTime;switch(n){case"tick":{a.type="square",a.frequency.setValueAtTime(1200,t),s.gain.setValueAtTime(.05,t),s.gain.exponentialRampToValueAtTime(.001,t+.04),a.start(t),a.stop(t+.04);break}case"spin":{for(let c=0;c<20;c++){const l=t+Math.pow(c/20,1.6)*2.2,p=o.createOscillator(),b=o.createGain();p.connect(b),b.connect(o.destination),p.type="square",p.frequency.setValueAtTime(1e3+Math.random()*300,l),b.gain.setValueAtTime(.05,l),b.gain.exponentialRampToValueAtTime(.001,l+.04),p.start(l),p.stop(l+.05)}break}case"zone":{for(let c=0;c<5;c++){const l=t+c*.12,p=o.createOscillator(),b=o.createGain();p.connect(b),b.connect(o.destination),p.type="sawtooth",p.frequency.setValueAtTime(160-c*15,l),p.frequency.exponentialRampToValueAtTime(40,l+.35),b.gain.setValueAtTime(.18,l),b.gain.exponentialRampToValueAtTime(.001,l+.4),p.start(l),p.stop(l+.4)}break}case"fire":a.type="sawtooth",a.frequency.setValueAtTime(150,t),a.frequency.exponentialRampToValueAtTime(60,t+.15),s.gain.setValueAtTime(.15,t),s.gain.exponentialRampToValueAtTime(.001,t+.2),a.start(t),a.stop(t+.2);break;case"hit":a.type="square",a.frequency.setValueAtTime(200,t),a.frequency.exponentialRampToValueAtTime(80,t+.4),s.gain.setValueAtTime(.2,t),s.gain.exponentialRampToValueAtTime(.001,t+.5),a.start(t),a.stop(t+.5);const i=o.createOscillator(),r=o.createGain();i.connect(r),r.connect(o.destination),i.type="triangle",i.frequency.setValueAtTime(400,t),i.frequency.exponentialRampToValueAtTime(100,t+.3),r.gain.setValueAtTime(.1,t),r.gain.exponentialRampToValueAtTime(.001,t+.35),i.start(t),i.stop(t+.35);break;case"sunk":for(let c=0;c<3;c++){const l=o.createOscillator(),p=o.createGain();l.connect(p),p.connect(o.destination),l.type="sawtooth",l.frequency.setValueAtTime(100-c*30,t+c*.15),l.frequency.exponentialRampToValueAtTime(30,t+c*.15+.5),p.gain.setValueAtTime(.2,t+c*.15),p.gain.exponentialRampToValueAtTime(.001,t+c*.15+.6),l.start(t+c*.15),l.stop(t+c*.15+.6)}break;case"miss":a.type="sine",a.frequency.setValueAtTime(600,t),a.frequency.exponentialRampToValueAtTime(300,t+.15),s.gain.setValueAtTime(.05,t),s.gain.exponentialRampToValueAtTime(.001,t+.2),a.start(t),a.stop(t+.2);break;case"win":[523,659,784,1047].forEach((c,l)=>{const p=o.createOscillator(),b=o.createGain();p.connect(b),b.connect(o.destination),p.type="triangle",p.frequency.setValueAtTime(c,t+l*.15),b.gain.setValueAtTime(.15,t+l*.15),b.gain.exponentialRampToValueAtTime(.001,t+l*.15+.4),p.start(t+l*.15),p.stop(t+l*.15+.4)});break;case"lose":[400,300,250,200].forEach((c,l)=>{const p=o.createOscillator(),b=o.createGain();p.connect(b),b.connect(o.destination),p.type="sawtooth",p.frequency.setValueAtTime(c,t+l*.2),b.gain.setValueAtTime(.12,t+l*.2),b.gain.exponentialRampToValueAtTime(.001,t+l*.2+.5),p.start(t+l*.2),p.stop(t+l*.2+.5)});break}}catch{}}}const $=new $e;function Ee(e){const n=["#00f0ff","#ff0055","#ffe600","#00ff88","#ff6600","#cc00ff"];for(let o=0;o<60;o++){const a=document.createElement("div");a.style.cssText=`
      ...
      opacity:1;
    `,e.appendChild(a),setTimeout(()=>a.remove(),3e3)}}const f=10,V=[5,4,3,3,2];let u="join",T="",h=0,J=0,Q=0,G=0,g="",Z=0,E=!1,z=!1,K=[],me=[],k=[],q=!0,D=A(),_=A(),S=!1,Y=0,X=!1,N=!1,w=!1,M=[],C=null,I=null,R;function A(){return Array.from({length:f},()=>Array(f).fill(0))}function be(){const e=location.protocol==="https:"?"wss":"ws";R=new WebSocket(`${e}://${location.host}/ws`),R.onopen=()=>{if(T&&u!=="join")m({type:"join",name:T});else{const n=sessionStorage.getItem("bs_name");n&&u==="join"&&(T=n,m({type:"join",name:n}))}},R.onmessage=n=>{try{ke(JSON.parse(n.data))}catch{}},R.onclose=()=>{setTimeout(be,2e3)}}function m(e){R&&R.readyState===WebSocket.OPEN&&R.send(JSON.stringify(e))}function ke(e){switch(e.type){case"joined":T=e.name,h=e.points,J=e.wins,Q=e.losses,sessionStorage.setItem("bs_name",T),u="lobby",m({type:"loan_status"}),v();break;case"lobby_update":K=e.players||[],me=e.leaderboard||[],e.me&&(h=e.me.points,J=e.me.wins,Q=e.me.losses),u==="lobby"&&v();break;case"challenge_sent":y(`Défi envoyé à ${e.target} — mise ${e.wager} pts ⏳`);break;case"challenge_received":Be(e.challenger,e.wager);break;case"challenge_declined":y(`${e.target} a refusé ton défi 😤`);break;case"game_start":g=e.opponent,Z=e.wager,G=e.playerIdx??0,k=[],q=!0,E=!1,z=!1,N=!1,w=!1,D=A(),_=A(),M=M.filter(a=>a.scope!=="game"),u="placement",v();break;case"ships_accepted":z=!0,u==="placement"&&v();break;case"opponent_ready":y(`${g} est prêt ! ⚓`);break;case"battle_start":E=!!e.yourTurn,u="battle",v();break;case"fire_result":{const{x:a,y:s,result:t,ship:i,shooter:r}=e,c=t==="hit"||t==="sunk";r===G?(D[s][a]=c?3:2,$.play(t==="sunk"?"sunk":c?"hit":"miss"),t==="sunk"?y(`💥 ${i} ennemi coulé !`):c&&y("🎯 Touché !")):(_[s][a]=c?3:2,$.play(c?"hit":"miss"),t==="sunk"&&y(`☠️ Ton ${i} a été coulé...`)),E=!!e.yourTurn,u==="battle"&&!e.gameOver&&(Ve(),te(),W(r===G?"enemy-grid":"own-grid",a,s,c));break}case"loan_approved":typeof e.newPoints=="number"&&(h=e.newPoints),I={principal:e.amount,remaining:e.amount+e.amount*e.rate/100,rate:e.rate,installment:e.installment||0,repaid:0},y(`🏦 Prêt de ${e.amount} pts accordé ! Taux: ${e.rate}%. Nouveau solde: ${h} pts`),u==="lobby"&&v();break;case"loan_status":I={principal:e.principal,remaining:e.remaining,rate:e.rate,installment:e.installment||0,repaid:e.repaid},u==="lobby"&&v();break;case"game_over":S=!!e.won,Y=e.pointsEarned||0,X=e.reason==="forfeit",typeof e.newPoints=="number"&&(h=e.newPoints),u="gameover",$.play(S?"win":"lose"),v(),S&&setTimeout(()=>Ee(document.body),200);break;case"rematch_requested":y(`${g} veut une revanche ! 🔄`);break;case"opponent_left":y(`${g} a quitté`),u==="gameover"&&v();break;case"spin_result":typeof e.spinnerPoints=="number"&&e.youSpun&&(h=e.spinnerPoints),_e(!!e.youBenefit,!!e.youSpun,()=>{e.youBenefit?(N=!0,y("💣 Attaque de zone 3×3 débloquée !")):y(`😱 ${g} a gagné l'attaque de zone !`),u==="battle"&&U()});break;case"zone_result":{const a=e.shooter===G;$.play("zone");let s=[];(e.cells||[]).forEach((t,i)=>{const{x:r,y:c,result:l}=t;if(l==="skip")return;const p=l==="hit"||l==="sunk";l==="sunk"&&t.ship&&s.push(t.ship),setTimeout(()=>{a?D[c][r]=p?3:2:_[c][r]=p?3:2,u==="battle"&&(te(),W(a?"enemy-grid":"own-grid",r,c,p))},i*110)}),a&&(N=!1,w=!1),E=!!e.yourTurn,setTimeout(()=>{s.length&&(y(a?`💥 Coulé : ${s.join(", ")} !`:`☠️ Coulé : ${s.join(", ")}...`),$.play("sunk")),u==="battle"&&!e.gameOver&&U()},1100);break}case"chat_history":case"live_matches":ne=e.matches||[],u==="lobby"&&xe();break;case"spectate_start":L=e.p1,B=e.p2,ae=e.board1||A(),se=e.board2||A(),fe=e.events||[],oe=e.turnName,ie=e.gameId||ie,P=0,u="spectate",v();break;case"spectate_fire":{const{x:a,y:s,result:t,shooter:i}=e,r=t==="hit"||t==="sunk",c=i===0?se:ae;c[s][a]=r?3:2,oe=e.turnName,u==="spectate"&&(he(),setTimeout(()=>W("spec-grid-"+(i===0?2:1),a,s,r),100));break}case"spectate_end":u="lobby",v();break;case"bets_resolved":y(`⚡ Paris résolus : ${e.kind}`);break;case"chat":M.push({id:e.id,from:e.from,text:e.text,scope:e.scope||"lobby",replyTo:e.replyTo||void 0,replySnip:e.replySnip||void 0}),M.length>150&&M.shift(),H();break;case"mention":$.play("hit");const n=e.text.slice(0,60)+(e.text.length>60?"…":""),o=document.createElement("div");o.className="toast toast-mention",o.innerHTML=`🔔 <strong>${d(e.from)}</strong> t'a mentionné<br/><em>${d(n)}</em>`,o.onclick=()=>{if(u==="battle"||u==="placement")return;const a=document.getElementById("chat-messages");a&&(a.scrollTop=a.scrollHeight)},document.body.appendChild(o),setTimeout(()=>o.remove(),3500),M.length<150&&M.push({from:e.from,text:e.text,scope:"lobby"}),H();break;case"odds":x={kind:e.kind||"",odds0:e.odds0||0,odds1:e.odds1||0},u==="spectate"&&ye();break;case"bet_placed":P-=e.amount,u==="spectate"&&ce(),y(`🎲 Pari placé : ${e.kind} → mise ${e.amount} pts, cote ${e.odds}x`);break;case"bet_won":h+=e.amount||0,P+=e.amount||0,u==="spectate"&&ce(),y(`💰 Pari gagné ! +${e.amount} pts (${e.kind})`),u==="lobby"&&v();break;case"error":y(`⚠️ ${e.message}`);break}}const O=document.getElementById("app");function v(){switch(u){case"join":Te();break;case"lobby":we();break;case"placement":Me();break;case"battle":U();break;case"gameover":Re();break;case"spectate":Ne();break}}function Te(){const e=sessionStorage.getItem("bs_name")||"";O.innerHTML=`
    ...
    </div>`;const n=document.getElementById("name-input"),o=()=>{const a=n.value.trim();a&&(T=a,m({type:"join",name:a}))};document.getElementById("join-btn").onclick=o,n.onkeydown=a=>{a.key==="Enter"&&o()},e&&(T=e,setTimeout(()=>m({type:"join",name:e}),100)),n.focus(),H()}function we(){O.innerHTML=`
    <div class="lobby-screen">
      <header class="lobby-header">
        ...
        <div class="my-badge">
          <span class="badge-name">${d(T)}</span>
    ...
    <li class="${t.name===T?"me":""}">
      <span class="lb-rank">${n[i]||i+1}</span>
      <span class="lb-name">${d(t.name)}</span>
      <span class="lb-pts">${t.points}</span>
    </li>`).join("");const o=document.getElementById("player-list"),a=K.filter(t=>t.name!==T);o.innerHTML=a.length?a.map(t=>`
    ...
    </div>`).join(""):`<p class="empty-msg">Personne d'autre en ligne...<br/>Partage l'adresse à tes amis !</p>`,o.querySelectorAll(".btn-challenge").forEach(t=>{t.addEventListener("click",()=>Ae(t.dataset.target))}),H(),le();const s=document.getElementById("borrow-btn");s&&(s.onclick=Le),m({type:"loan_status"}),m({type:"live_matches"})}function xe(){const e=document.getElementById("live-matches");if(e){if(ne.length===0){e.innerHTML='<p class="empty-msg">Pas de match en cours</p>';return}e.innerHTML=ne.map(n=>`
  ...
  `).join(""),e.querySelectorAll(".btn-challenge").forEach(n=>{n.addEventListener("click",()=>m({type:"spectate",gameId:n.dataset.game}))})}}function Ie(){if(!I)return h<75?'<div class="loan-cta"><button id="borrow-btn" class="btn-spin">🏦 Emprunter à la banque</button></div>':"";const e=Math.round((1-I.remaining/(I.principal*(1+I.rate/100)))*100);return`<div class="loan-cta"><span class="loan-status">🏦 Dette: ${I.remaining} pts (${e}% remboursé${I.installment>0?` · -${I.installment}/victoire`:" · en une fois"})</span></div>`}function Ae(e){j();const n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
    ...
    <div class="place-screen">
      ...
      <div class="place-progress">${V.map((s,t)=>`<span class="prog-dot ${t<e?"done":t===e?"current":""}">${s}</span>`).join("")}</div>
      <div id="place-grid" class="grid place-grid"></div>
      <div class="place-actions">
        <button id="rotate-btn" class="btn-action">↻ ${q?"Horizontal":"Vertical"}</button>
      ...
      ${n?"":`<p class="help-text">Touche la grille pour placer le bateau de ${V[e]} cases</p>`}
      `}
    </div>`,z)return;Ce(),document.getElementById("rotate-btn").onclick=()=>{q=!q,v()},document.getElementById("random-btn").onclick=()=>{qe(),v()};const o=document.getElementById("reset-btn");o&&(o.onclick=()=>{k=[],_=A(),v()});const a=document.getElementById("confirm-btn");a&&(a.onclick=()=>{m({type:"place_ships",ships:k}),$.play("fire")})}function Se(){const e=new Set;return k.forEach((n,o)=>{for(let a=0;a<V[o];a++){const s=n.horiz?n.row:n.row+a,t=n.horiz?n.col+a:n.col;e.add(`${s},${t}`)}}),e}function ee(e,n,o,a){const s=Se();for(let t=0;t<o;t++){const i=a?e:e+t,r=a?n+t:n;if(i<0||i>=f||r<0||r>=f||s.has(`${i},${r}`))return!1}return!0}function ve(){_=A(),k.forEach((e,n)=>{for(let o=0;o<V[n];o++){const a=e.horiz?e.row:e.row+o,s=e.horiz?e.col+o:e.col;_[a][s]=1}})}function qe(){k=[];for(const e of V)for(let n=0;n<500;n++){const o=Math.random()>.5,a=Math.floor(Math.random()*f),s=Math.floor(Math.random()*f);if(ee(a,s,e,o)){k.push({row:a,col:s,horiz:o});break}}ve()}function Ce(){const e=document.getElementById("place-grid");if(!e)return;ve();const n=k.length<V.length?V[k.length]:0;e.innerHTML="";const o=()=>e.querySelectorAll(".preview, .preview-bad").forEach(s=>s.classList.remove("preview","preview-bad")),a=(s,t)=>{if(o(),!n)return;const i=ee(s,t,n,q);for(let r=0;r<n;r++){const c=q?s:s+r,l=q?t+r:t;c>=0&&c<f&&l>=0&&l<f&&e.children[c*f+l]?.classList.add(i?"preview":"preview-bad")}};for(let s=0;s<f;s++)for(let t=0;t<f;t++){const i=document.createElement("div");i.className="gcell",_[s][t]===1&&(i.classList.add("ship"),i.classList.add("removable")),i.addEventListener("pointerenter",()=>a(s,t)),i.addEventListener("click",()=>{if(_[s][t]===1){const r=k.findIndex((c,l)=>{for(let p=0;p<V[l];p++){const b=c.horiz?c.row:c.row+p,ge=c.horiz?c.col+p:c.col;if(b===s&&ge===t)return!0}return!1});r>=0&&(k.splice(r,1),$.play("miss"),v());return}n&&ee(s,t,n,q)&&(k.push({row:s,col:t,horiz:q}),$.play("miss"),v())}),e.appendChild(i)}e.addEventListener("pointerleave",o)}function U(){O.innerHTML=`
    <div class="battle-screen">
      ...
      <div id="turn-indicator" class="turn-indicator ${E?"my-turn":""}">
        ${E?w?"💣 CHOISIS LE CENTRE DE LA ZONE 3×3":"🎯 À TOI DE TIRER !":"⏳ "+d(g)+" vise..."}
      </div>
      ...
      <div class="power-bar">
        ...
        ${N&&E?`<button id="zone-btn" class="btn-zone ${w?"active":""}">💣 ZONE 3×3 ${w?"— annuler":""}</button>`:""}
        ${N&&!E?'<span class="zone-pending">💣 Zone 3×3 prête pour ton tour</span>':""}
      </div>
    ...
    </div>`,te(),document.getElementById("forfeit-btn").onclick=()=>{confirm("Abandonner ? Tu perds la mise !")&&(m({type:"leave_game"}),u="lobby",v())};const e=document.getElementById("spin-btn");e&&(e.onclick=()=>{$.play("spin"),m({type:"spin"})});const n=document.getElementById("zone-btn");n&&(n.onclick=()=>{w=!w,U()}),H(),le()}function Ve(){const e=document.getElementById("turn-indicator");e&&(e.className=`turn-indicator ${E?"my-turn":""}`,e.innerHTML=E?"🎯 À TOI DE TIRER !":"⏳ "+d(g)+" vise...")}function te(){const e=document.getElementById("enemy-grid");if(e){e.innerHTML="";const o=()=>e.querySelectorAll(".zone-target").forEach(s=>s.classList.remove("zone-target")),a=(s,t)=>{o();for(let i=-1;i<=1;i++)for(let r=-1;r<=1;r++){const c=s+i,l=t+r;c>=0&&c<f&&l>=0&&l<f&&e.children[c*f+l]?.classList.add("zone-target")}};for(let s=0;s<f;s++)for(let t=0;t<f;t++){const i=document.createElement("div");i.className="gcell water";const r=D[s][t];r===2&&(i.classList.add("miss"),i.textContent="•"),r===3&&(i.classList.add("hit"),i.textContent="✕"),E&&w?(i.classList.add("clickable"),i.addEventListener("pointerenter",()=>a(s,t)),i.onclick=()=>{!E||!N||($.play("fire"),m({type:"fire_zone",x:t,y:s}),w=!1)}):r===0&&E&&(i.classList.add("clickable"),i.onclick=()=>{E&&($.play("fire"),m({type:"fire",x:t,y:s}))}),e.appendChild(i)}w&&e.addEventListener("pointerleave",o)}const n=document.getElementById("own-grid");if(n){n.innerHTML="";for(let o=0;o<f;o++)for(let a=0;a<f;a++){const s=document.createElement("div");s.className="gcell water";const t=_[o][a];t===1&&s.classList.add("ship"),t===2&&(s.classList.add("miss"),s.textContent="•"),t===3&&(s.classList.add("hit","ship-hit"),s.textContent="✕"),n.appendChild(s)}}}function _e(e,n,o){j();const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a),$.play("spin");const s=document.getElementById("spin-wheel"),t=e?90:270,i=Math.random()*100-50,r=5*360+(360-t)+i*.6;requestAnimationFrame(()=>{s.style.transition="transform 2.4s cubic-bezier(0.15, 0.9, 0.25, 1)",s.style.transform=`rotate(${r}deg)`}),setTimeout(()=>{const c=document.getElementById("spin-verdict");c&&(c.textContent=e?"💣 TU GAGNES L'ATTAQUE DE ZONE !":`😈 ${g} gagne l'attaque de zone !`,c.className=`spin-verdict show ${e?"good":"bad"}`),$.play(e?"win":"lose")},2500),setTimeout(()=>{a.remove(),o()},4200)}function W(e,n,o,a){const s=document.getElementById(e);if(!s)return;const t=s.children[o*f+n];t&&(t.classList.add(a?"explode":"splash"),setTimeout(()=>t.classList.remove("explode","splash"),700))}function Re(){O.innerHTML=`
    <div class="gameover-screen ${S?"win":"lose"}">
      <div class="go-icon">${S?"🏆":"💀"}</div>
      <h1>${S?"VICTOIRE !":"DÉFAITE"}</h1>
      <p class="go-detail">
        ${X?d(g)+" a abandonné !":S?"Tu as coulé toute la flotte de "+d(g)+" !":d(g)+" a coulé toute ta flotte..."}
      </p>
      ${Y>0?`<p class="go-points ${S?"gain":"loss"}">${S?"+":"-"}${Y} points</p>`:""}
    ...
    </div>`;const e=document.getElementById("rematch-btn");e&&(e.onclick=()=>{m({type:"rematch"}),y("Revanche proposée, en attente..."),e.setAttribute("disabled","true"),e.textContent="⏳ En attente..."}),document.getElementById("lobby-btn").onclick=()=>{m({type:"leave_game"}),u="lobby",v()}}function H(){const e=document.getElementById("join-chat-msgs");e&&(e.innerHTML=M.filter(s=>s.scope==="lobby").slice(-15).map(s=>de(s)).join("")||'<p class="empty-msg">Silence radio pour le moment...</p>',e.scrollTop=e.scrollHeight);const n=document.getElementById("chat-messages");if(!n)return;const o=u==="battle"||u==="placement"?"game":u==="spectate"?"spec":"lobby",a=M.filter(s=>s.scope===o);n.innerHTML=a.map((s,t)=>de(s,t)).join(""),n.scrollTop=n.scrollHeight,n.querySelectorAll(".chat-reply-btn").forEach(s=>{s.addEventListener("click",t=>{t.stopPropagation();const i=s.closest(".chat-msg"),r=parseInt(i?.dataset.i||"0"),c=a[r];c&&(C={id:c.id||"",from:c.from,text:c.text}),F()})}),n.querySelectorAll(".chat-mention").forEach(s=>{s.addEventListener("click",()=>{const t=s.getAttribute("data-name")||"";for(let i=a.length-1;i>=0;i--)if(a[i].from===t){const r=n.children[i];r&&(r.scrollIntoView({behavior:"smooth",block:"center"}),r.classList.add("msg-flash"),setTimeout(()=>r.classList.remove("msg-flash"),1800));return}y(`${t} n'a pas de message récent ici`)})})}function de(e,n){const o=e.from===T,a=e.replyTo?`<div class="reply-quote"><span class="reply-quote-bar"></span><span class="reply-quote-text">${d(e.replySnip||"")}</span></div>`:"",s=Pe(e.text),t=n!==void 0?` data-i="${n}"`:"";return`<div class="chat-msg ${o?"mine":""}"${t}>
    ${a}
    <span class="chat-from">${d(e.from)}</span>
    <span class="chat-text">${s}</span>
    <button class="chat-reply-btn" title="Répondre">↩</button>
  </div>`}function Pe(e){return e.replace(/(^| )@([a-zA-Z0-9_-]+)/g,(n,o,a)=>`${o}<span class="chat-mention" data-name="${re(a)}">@${d(a)}</span>`)}function F(){if(document.getElementById("reply-bar")?.remove(),!C)return;const e=document.querySelector(".chat-input")?.parentElement;if(!e)return;const n=document.createElement("div");n.id="reply-bar",n.className="reply-bar",n.innerHTML=`
    <div class="reply-bar-top"></div>
    <span class="reply-bar-label">Répondre à <strong>${d(C.from)}</strong></span>
    <span class="reply-bar-snip">${d(C.text.slice(0,50))}${C.text.length>50?"…":""}</span>
    <button class="reply-bar-cancel">✕</button>
  `,e.insertBefore(n,e.firstChild),n.querySelector(".reply-bar-cancel").addEventListener("click",()=>{C=null,F()})}function le(){const e=document.getElementById("chat-inp"),n=document.getElementById("chat-send-btn");if(!e||!n)return;const o=()=>{const a=e.value.trim();if(!a)return;const s={type:"chat",text:a};C&&(s.replyTo=C.id,C=null,F()),m(s),e.value=""};n.onclick=o,e.onkeydown=a=>{a.key==="Enter"&&o()},F()}let pe;function y(e){document.querySelectorAll(".toast").forEach(o=>o.remove()),clearTimeout(pe);const n=document.createElement("div");n.className="toast",n.textContent=e,document.body.appendChild(n),pe=setTimeout(()=>n.remove(),2800)}function d(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}let ne=[],L="",B="",ae=A(),se=A(),fe=[],oe="",x=null,ie="",P=0;function Ne(){O.innerHTML=`<div class="spectate-screen">
    <header class="battle-header spec-header">
      <span class="vs-text">${d(L)} <span class="vs">VS</span> ${d(B)}</span>
      <span class="wager-badge">💰 ${Z} pts</span>
    ...
    <div class="spec-grids-top">
      <div class="battle-section"><h3>🛡️ ${d(L)}</h3><div id="spec-grid-1" class="grid spec-grid"></div></div>
      <div class="battle-section"><h3>🎯 ${d(B)}</h3><div id="spec-grid-2" class="grid spec-grid"></div></div>
    </div>
  ...
  </div>`,he(),document.getElementById("unspectate-btn").onclick=()=>{m({type:"unspectate"}),u="lobby",v()},He(),ye(),ce(),H(),le()}function he(){const e=document.getElementById("spec-grid-1");e&&ue(e,ae);const n=document.getElementById("spec-grid-2");n&&ue(n,se)}function ue(e,n){e.innerHTML="";for(let o=0;o<f;o++)for(let a=0;a<f;a++){const s=document.createElement("div");s.className="gcell water";const t=n[o][a];t===1&&s.classList.add("ship"),t===2&&(s.classList.add("miss"),s.textContent="•"),t===3&&(s.classList.add("hit","ship-hit"),s.textContent="✕"),e.appendChild(s)}}function He(){const e=document.getElementById("spec-events");e&&(e.innerHTML=fe.slice(-10).reverse().map(n=>{const o=n.player===0?L:B,a=n.data||{};return`<div class="spec-event">${a.result==="hit"?"🎯":a.result==="sunk"?"💥":"💧"} <strong>${d(o)}</strong> ${a.x},${a.y} ${a.ship||""}</div>`}).join(""))}function ce(){const e=document.getElementById("spec-balance");if(!e)return;const n=P>0?"gain":P<0?"loss":"",o=P>=0?"+":"";e.textContent=o+P+" pts",e.className="spec-balance "+n}function ye(){const e=document.getElementById("spec-bet-btns");if(!e||!x)return;const n=document.getElementById("odd-val-0"),o=document.getElementById("odd-val-1");n&&(n.textContent=x.odds0+"x"),o&&(o.textContent=x.odds1+"x");const a=document.getElementById("odd-card-0"),s=document.getElementById("odd-card-1");a&&(a.className="odd-card pick0"+(x.odds0>x.odds1?" favorite":"")),s&&(s.className="odd-card pick1"+(x.odds1>x.odds0?" favorite":"")),e.innerHTML=`
  ...
  `,e.querySelectorAll(".btn-bet").forEach(t=>t.addEventListener("click",()=>{const i=t.dataset.kind,r=parseInt(t.dataset.pick);Oe(i,r)}))}function Oe(e,n){j();const o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`<div class="modal">
    ...
    <p>Tu paries sur <strong>${d(n===1?L:B)}</strong></p>
